"""Ported verbatim from cvn/app/crowd_loc/Networks/HR_Net/models.py.

Not imported by get_seg_model() -- the actual network config comes from
default.py's yacs CfgNode merged with seg_hrnet_w48.yaml. This alternate
config structure (HRNet-W32 channel sizes) appears to predate that
yaml-driven approach and is unused in the legacy code's actual model-loading
path. Ported anyway for fidelity with the source being replaced.
"""
