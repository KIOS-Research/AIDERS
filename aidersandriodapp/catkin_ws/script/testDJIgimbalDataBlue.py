...
def listener(dji_name = "spark_blue"):
	...
	while not rospy.is_shutdown(): 			
		...
		t.gimbalControlData.pitch=-70.0 '''//value of rotation in degrees (negative for down motion)''' 
		t.gimbalControlData.time=3
		publisher.publish(t)	
		print("Published: ")
		print(t)
		rate.sleep()
		...
		t.gimbalControlData.roll=-1.0
		t.gimbalControlData.yaw=-1.0
		t.gimbalControlData.pitch=90.0 '''//value of rotation in degrees (positive for up motion)'''
		t.gimbalControlData.time=3
		publisher.publish(t)	
		print("Published: ")
		print(t)
