...
def listener(dji_name = "Mavic_2_Enterprise_Kios"):
	...
	while not rospy.is_shutdown():
		t = InputDJI()
		t.isFlightControlData = True
		t.flightControlData.enableVirtalControlStick= True
		t.flightControlData.pitch=0
		t.flightControlData.roll=0
		t.flightControlData.yaw=180
		t.flightControlData.verticalThrottle=20
		publisher.publish(t)	
		print("Published: ")
		print(t)
