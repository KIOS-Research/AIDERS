            ...
            with dt[1]:
                if self.custom_model is None:
                    ...
                    if not(self.get_feature):
                        ...
                        #preds_ = model(batch['img'], augment=augment)
                        #print("ZZZZZZZ", yolov8_features[0].shape, yolov8_features[1].shape, yolov8_features[2].shape)
                        ...
                        # self.last_features.append(yolov8_features)
                #preds = model.custom_forward(batch['img'], augment=augment)
                #print("preds", batch['img'][0,:,:,:])
                #print("ZZZZZZZZZZ", len(preds), preds[0].shape)
