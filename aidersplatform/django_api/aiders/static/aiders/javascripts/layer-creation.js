...
function createLineLayer(droneID) {
    return new MapboxLayer({
        id: 'drone' + droneID + 'line',
        type: LineLayer,
        data: [],
        fp64: false,
        widthScale: 0.1,
...
function create_layers_for_new_drone(allDronesArray, index) {
    var drone_id = allDronesArray[index].droneID;
    allDronesArray[index].droneLineLayer = createLineLayer(drone_id);
