{
    ...
    function clearFireDataFromMap()
    {
        ...
        create_confirmation_dialog(okButton,cancelButton,message,dialogTitle).then(function (willClear)
        {
            if (willClear)
            {
                ...
                for (let source_id in all_sources) //Remove the images from the map that belong to the period that user specified
                {
    ...
    function check_for_empty_value(timeStepsInput, initialFFinput, windAngleInput, windSpeedInput, fireSpeedInput, timeStepUnit, timeIntervalInput, lon)
    {
        let msg
        let canProceed = true
    ...
    function submitFireSpreadInput()
    {
        ...
        let obj = check_for_empty_value(timeStepsInput, initialFFinput,windAngleInput , windSpeedInput, fireSpeedInput, timeStepUnit, timeIntervalInput, lonMarker, operationInput, userInput)
