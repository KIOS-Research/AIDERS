...

{
    ...
    function add_Drone(droneID, dronePK) {
        allDroneInfo.push({
            ...
            droneTelemetryURL: dutils.urls.resolve('telemetry', { operation_name: CURRENT_OP, drone_name: droneID }),
            missionPointsURL: dutils.urls.resolve('mission_points', {
                operation_name: CURRENT_OP,
                drone_name: droneID,
            }),
            detectionStatusURL: dutils.urls.resolve('start_stop_detection', {
                operation_name: CURRENT_OP,
                drone_name: droneID,
            }),
            liveStreamStatusURL: dutils.urls.resolve('live_stream_status', {
                operation_name: CURRENT_OP,
                drone_name: droneID,
            }),
            lastDetectionFrameURL: dutils.urls.resolve('last_detection_frame', {
                operation_name: CURRENT_OP,
                drone_name: droneID,
            }),
            lastRawFrameURL: dutils.urls.resolve('last_raw_frame', { operation_name: CURRENT_OP, drone_name: droneID }),
            liveStreamHLSUrl: `http://${NET_IP}:8080/hls/${droneID}.m3u8`,
