...
* */
{
    ...
    {
        // console.log("RGBA String")
        // console.log('rgba(1,1,1,0.3)'.replace(/[^,]+(?=\))/, '0.5'))
        // console.log("RGBA OBJ")
        // console.log(rgba(153, 102, 255))
        let colour = availableColors[0]
        availableColors.shift()
        availableColors.push(colour)
        return colour
    }
    ...
    function getHullBoxColor(pos)
    {
        return hullBoxColors[pos]
    }

    function getBasicColor(pos)
    {
        return basicColors[pos]
    }
