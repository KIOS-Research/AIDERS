...
class Safe_Drones:
    ...
    def Motor_Failure_Risk_Calc(self, MotorStatus, Motors_Configuration, Motors_Lambda, time):
        ...
        if Motors_Configuration == 'PNPN':
            ...
            if SysState == 6:
                ...
                if (MotorStatus[0] + MotorStatus[3]) == 0 or (MotorStatus[1] + MotorStatus[4]) == 0 or (
                        MotorStatus[2] + MotorStatus[5]) == 0:
    ...
    def Battery_Failure_Risk_Calc(self, BatteryStatus, time, Lambda=0.001, alpha=0.008, beta=0.007,
