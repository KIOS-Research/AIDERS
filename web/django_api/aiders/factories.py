...
class DroneFactory(factory.django.DjangoModelFactory):
    ...
    # time = factory.fuzzy.FuzzyDateTime(datetime.datetime.now().replace(tzinfo=datetime.timezone.utc))
...
class DetectionFrameFactory(factory.django.DjangoModelFactory):
    ...
    frame = factory.LazyAttribute(lambda _: ContentFile(factory.django.ImageField()._make_data({"width": 1024, "height": 768}), "example.jpg"))
...
class MissionFactory(factory.django.DjangoModelFactory):
    ...
    mission_type = factory.Faker("random_choices", elements=["NORMAL_MISSION", "SEARCH_AND_RESCUE_MISSION", "GRID_MISSION"])
...
class MissionLogFactory(factory.django.DjangoModelFactory):
    ...
    action = factory.Faker("random_choices", elements=["START_MISSION", "PAUSE_MISSION", "RESUME_MISSION", "CANCEL_MISSION"])
    operation = factory.Iterator(Operation.objects.all())
    user = factory.Iterator(User.objects.all())
    drone = factory.Iterator(Drone.objects.all())
    algorithm = None
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    last_login = factory.fuzzy.FuzzyDateTime(datetime.datetime(2008, 1, 1, tzinfo=pytz.UTC))
    is_active = True
    date_joined = factory.fuzzy.FuzzyDateTime(datetime.datetime(2005, 1, 1, tzinfo=pytz.UTC), datetime.datetime(2008, 1, 1, tzinfo=pytz.UTC))
    is_staff = True
    is_superuser = True
...
class AlgorithmFactory(factory.django.DjangoModelFactory):
    ...
    algorithm_name = factory.fuzzy.FuzzyChoice(["FIRE_PROPAGATION_ALGORITHM", "CREATE_3D_OBJECT_ALGORITHM"])
        ...
        "features": [
            {
                ...
                "properties": {"Fire Fronts": 395, "Fire Speed (m/s)": 5.0, "ID": 1, "Time Step": "250 seconds", "Wind Speed (m/s)": 5.0},
                "type": "Feature",
            },
            {
                "geometry": {
                ...
                "properties": {"Fire Fronts": 749, "Fire Speed (m/s)": 5.0, "ID": 2, "Time Step": "500 seconds", "Wind Speed (m/s)": 5.0},
                "type": "Feature",
            },
            {
                "geometry": {
                ...
                "properties": {"Fire Fronts": 1123, "Fire Speed (m/s)": 5.0, "ID": 3, "Time Step": "750 seconds", "Wind Speed (m/s)": 5.0},
                "type": "Feature",
            },
            {
                "geometry": {
                ...
                "properties": {"Fire Fronts": 1496, "Fire Speed (m/s)": 5.0, "ID": 4, "Time Step": "1000 seconds", "Wind Speed (m/s)": 5.0},
                "type": "Feature",
            },
        ],
