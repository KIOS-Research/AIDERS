...
PROJECT_DIR = "/app"
DETECTION_CONFIG_DIR = os.path.join(PROJECT_DIR, "app/logic/algorithms/object_detection/src/models/cfg/")
...
# DETECT_TRACK_SCRIPT_DIRECTORY = '/aiders/swifters/web/object_detection'
...
# ROS_MISSION_SCRIPT_DIRECTORY = '/aiders/swifters/web/python_LocUpdate_Script/'
...
BUILD_MAP_ADVANCE_DIR_PREFIX = "Build_Maps_Advances_"
DEVICE_IMAGE_DIR_PREFIX = "Device_Images_"
...
img_georeference_photos_csv_header_names = ",".join(
    ["photo_id", "p1lat", "p1lon", "p2lat", "p2lon", "p3lat", "p3lon", "p4lat", "p4lon", "alt", "bearing", "centerlat", "centerlon"]
)
...
START_LORA_LOCATION_RECEIVER_SCRIPT_COMMAND = [
    PROJECT_VIRTUAL_ENVIRONMENT_PATH,
    LORA_LOCATION_RECEIVER_SCRIPT_PATH,
    API_URL,
    LORA_RECEIVER_DEVICE_SYMLINK_PATH,
]
