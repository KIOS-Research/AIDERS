...
from logic.algorithms.object_detection.src.models.yolo_opencv import Yolo_detector_ocv
if torch.cuda.is_available():
    from logic.algorithms.object_detection.src.models.tensorrt import YOLODetector, YOLODetector_batch
...
from logic.algorithms.object_detection.src.models.yolov5 import *
...
class MOT:
    ...
    def print_timing_info(frame_count):
        ...
        LOGGER.debug(f"{'Total duration:':<37}{Profiler.get_duration('app'):>6.3f} s")
    ...
    def get_total_duration():
        return f"{Profiler.get_duration('app'):>6.3f}"
