...
def safe_download(file, url, url2=None, min_bytes=1E0, error_msg=''):
    ...
    from logic.algorithms.object_detection.src.utils.torch_yv5.utils.general import LOGGER
...
def attempt_download(file, repo='ultralytics/yolov5'):  # from logic.algorithms.object_detection.src.utils.torch_yv5.utils.downloads import *; attempt_download()
