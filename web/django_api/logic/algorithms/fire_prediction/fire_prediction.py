...
def main(R, fire_fronts, wind_speed, wind_angle, time_steps, time_unit, lon, lat, time_intervals):
    time_intervals = list(time_intervals.split(","))
    time_intervals = list(map(int, time_intervals))
    all_fire_polygons = predictFire(R, fire_fronts, wind_speed, wind_angle, time_steps, time_unit, lon,lat,
                                    time_intervals)
...
if __name__ == '__main__':
    ...
    print(main(fire_speed, fire_fronts, wind_speed, wind_angle, time_steps, time_unit, lon,lat , time_intervals))
