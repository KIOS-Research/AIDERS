...
from object_detection.src.utils.torch_yv5.models.yolo import Detect
from object_detection.src.utils.torch_yv5.utils.datasets import LoadImages
from object_detection.src.utils.torch_yv5.utils.general import (LOGGER, check_dataset, check_img_size, check_requirements, check_version, colorstr,
                           file_size, print_args, url2file)
from object_detection.src.utils.torch_yv5.utils.torch_utils import select_device
...
def export_saved_model(model,
    ...
    try:
        ...
        from object_detection.src.utils.torch_yv5.models.tf import TFDetect, TFModel
...
def export_tflite(keras_model, im, file, int8, data, nms, agnostic_nms, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        ...
        if int8:
            from object_detection.src.utils.torch_yv5.models.tf import representative_dataset_gen
